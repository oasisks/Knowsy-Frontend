                ...
                <template #content>
                    ...
                    <div class="posts">
                        <Card>
                            ...
                            <template #content>
                                <Dialog v-model:visible="visible" modal header="Create Post" :style="{ width: '50rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }" :dismissable-mask="true" v-on:after-hide="postContent = ''">
